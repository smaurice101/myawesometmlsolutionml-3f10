Scaling [myawesometmlsolutionml-3f10] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolutionml-3f10] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolutionml-3f10.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolutionml-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolutionml-3f10.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolutionml-3f10.yml

myawesometmlsolutionml-3f10.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolutionml-3f10.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-3f10/ymls/myawesometmlsolutionml-3f10
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolutionml-3f10.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolutionml-3f10
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolutionml-3f10
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolutionml-3f10
             image: maadsdocker/myawesometmlsolutionml-3f10-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'myawesometmlsolutionml-3f10'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolutionml-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolutionml-3f10-visualization-service
       labels:
         app: myawesometmlsolutionml-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolutionml-3f10 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolutionml-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolutionml-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolutionml-3f10.yml

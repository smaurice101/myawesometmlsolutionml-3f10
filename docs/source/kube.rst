...
Generated On: 2025-02-08 19:15:18 UTC
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolutionml-3f10 43097:43097

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:43097/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1

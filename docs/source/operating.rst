...
.. code-block::
   ...
   docker run -d -p 49211:49211 -p 56483:56483 -p 49947:49947 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=49211 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=56483 \
          --env SOLUTIONVIPERVIZPORT=49947 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=49211, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37299, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=32889, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36323, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33609, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33205, HPDEHOST=127.0.1.1, HPDEPORT=40963, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37731

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-235-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-6098-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-3277-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-3599-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict

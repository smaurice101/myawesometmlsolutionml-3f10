...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35321  \-\-env VIPERVIZPORT=56495  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:56495/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56495/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 50781:50781 -p 42373:42373 -p 47339:47339 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=50781  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=42373  \-\-env SOLUTIONVIPERVIZPORT=47339 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=35321 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=56495 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolutionml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=47339
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=50781
...
It can be accessed by entering: http://localhost:42373
...
.. important::
   http://localhost:47339/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:47339/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:47339/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=50781, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33555, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41485, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38795, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45479, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44021, HPDEHOST=127.0.1.1, HPDEPORT=44347, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33401

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2904-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-7104-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-6792-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-8522-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict

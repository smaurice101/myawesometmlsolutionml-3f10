[myawesometmlsolutionml-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-3f10] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43093  \-\-env VIPERVIZPORT=48783  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:48783/iot-failure-machinelearning-seneca.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:48783/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 49637:49637 -p 42727:42727 -p 35943:35943 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=49637  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=42727  \-\-env SOLUTIONVIPERVIZPORT=35943 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=43093 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=48783 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolutionml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=35943
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49637
...
It can be accessed by entering: http://localhost:42727
...
.. important::
   http://localhost:35943/iot-failure-machinelearning-seneca.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:35943/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:35943/<html file>
...
[myawesometmlsolutionml-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49637, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35149, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44015, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37475, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45691, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45091, HPDEHOST=127.0.1.1, HPDEPORT=34079, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33301

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5228-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-5369-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-6148-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-8377-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict

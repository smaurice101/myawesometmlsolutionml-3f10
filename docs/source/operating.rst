...
Generated On: 2024-10-22 18:51:12 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41175  \-\-env VIPERVIZPORT=36705  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:36705/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:36705/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 51435:51435 -p 39321:39321 -p 39943:39943 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=51435  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=39321  \-\-env SOLUTIONVIPERVIZPORT=39943 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=41175 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=36705 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolutionml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=39943
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=51435
...
It can be accessed by entering: http://localhost:39321
...
.. important::
   http://localhost:39943/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:39943/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:39943/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51435, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43149, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36525, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39941, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36431, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34921, HPDEHOST=127.0.1.1, HPDEPORT=39667, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35221

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5543-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-2695-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-5323-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-9427-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict

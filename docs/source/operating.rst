...
Generated On: 2024-10-17 21:04:09 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45377  \-\-env VIPERVIZPORT=51731  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:51731/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51731/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 47267:47267 -p 44335:44335 -p 52559:52559 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=47267  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=44335  \-\-env SOLUTIONVIPERVIZPORT=52559 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=45377 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=51731 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolutionml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=52559
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=47267
...
It can be accessed by entering: http://localhost:44335
...
.. important::
   http://localhost:52559/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52559/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:52559/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47267, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46529, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34363, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34247, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36721, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36373, HPDEHOST=127.0.1.1, HPDEPORT=42553, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33965

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9195-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-preprocess-2744-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-ml-6857-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, python-predict-1364-myawesometmlsolutionml-3f10,solution_preprocessing_ml_dag-myawesometmlsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict

...
.. code-block::
   ...
   docker run -d -p 33487:33487 -p 52667:52667 -p 43037:43037 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=33487 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=52667 \
          --env SOLUTIONVIPERVIZPORT=43037 \
...
It can be accessed by entering: http://localhost:52667
...
.. important::
   http://localhost:43037/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:43037/<html file>
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=33487, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38275, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35161, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35381, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35635, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38905, HPDEHOST=127.0.1.1, HPDEPORT=43821, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41145
